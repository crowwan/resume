...
2023년 9월부터 AI 기반 치과 CAD/CAM SaaS인 Dentbird의 프론트엔드를 맡아, 화면 구현부터 모노레포·환경 분리·품질 자동화 같은 플랫폼 토대까지 폭넓게 다뤄 왔습니다. 문제를 빠르게 덮기보다 근본 원인을 이해하고 재현으로 확인하며, 트레이드오프를 따져 도입을 결정하는 방식으로 일합니다. 개발 전반에 AI를 적극 활용하되, AI가 내놓은 결과를 사실로 검증하고 판단은 직접 내립니다.
